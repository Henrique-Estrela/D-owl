...
<div class=" centralize-total t-5 b-3">
            ...
            width="100%" height="100%"  allowtransparency="true" scrolling="no" style="border:none; background-color: #000; border: #ff2f1c solid 5px;  height: auto; border-radius: 3rem;  width: 60vw;background-color: rgb(255, 255, 255) !important;"></iframe>
            </div></section>';
